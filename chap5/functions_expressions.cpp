/*
Instead of assigning box to a variable we can call it directory as shown below.
*/
/*
A program that sums the volume of three boxes and then displays the average volume
*/
